...
public class JsonItemStack {
  ...
  public static String toJson(ItemStack itemStack) {
    ...
    if (itemStack.hasItemMeta()) {
      ...
      if (meta.hasDisplayName()) {
        metaJson.addProperty("displayname", meta.getDisplayName().replaceAll("§", "&"));
      }
      if (meta.hasLore()) {
        JsonArray lore = new JsonArray();
        meta.getLore().forEach(str -> lore.add(new JsonPrimitive(str.replaceAll("§", "&"))));
  ...
  public static ItemStack fromJson(String string) {
    ...
    if (itemJson != null && itemJson.isJsonObject()) {
      ...
      if (typeElement.isJsonPrimitive()) {
        ...
        if (itemMetaElement != null && itemMetaElement.isJsonObject()) {
          ...
          if (displaynameElement != null && displaynameElement.isJsonPrimitive()) {
            meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', displaynameElement.getAsString()));
          }
          ...
          if (extrametaElement != null && extrametaElement.isJsonObject()) {
            try {
              ...
              if (meta instanceof SkullMeta) {
                 ...
                 * 
                 * JsonElement colorElement = extraJson.get("color"); if(colorElement != null &&
